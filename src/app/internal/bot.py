...
from app.internal.transport.bot.handlers import start, set_phone, get_info, get_card_balance,\
    ...
    get_favorite_users, transfer_money_by_name, get_account_statement, get_users_interacted_with, set_password
...
def start_bot():
    ...
    app.add_handler(CommandHandler("transfer_name", transfer_money_by_name))
